...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class=".col-md-8">
                    <p class="text-muted lead">Tienes actualmente
                        <asp:Label ID="lblProductosActuales" runat="server" Text=""></asp:Label>
                        producto(s) en tu carrito.</p>
                </div>
                ...
                <div class="box-footer">
                            ...
                            <div class="pull-right">
                                ...
                                <asp:Button ID="btnIr1" runat="server" cssClass="btn btn-template-main" Text="Comprar" OnClick="btnIr1_Click" /> <i class="fa fa-chevron-right"></i>
